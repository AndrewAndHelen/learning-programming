...
{
	/*情景2
	1.如果expr是左值，T和ParamType都会被推导为左值引⽤。这⾮常不寻常，第⼀，这是模板类型推
...
void case3()
{
	...
	2. 如果忽略引⽤之后expr是⼀个const，那就再忽略const。如果它是volatile，也会被忽略（volatile
